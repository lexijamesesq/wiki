...
```json
{
  "fix_plan": {
    ...
    "created": "YYYY-MM-DD",
    "patches": [
      { "target": "{workspace_root}/System/Knowledge/example.md",
      ...
      { "target": "{workspace_root}/Wiki/Knowledge/other-example.md",
        "pre_state_hash": "<64-char sha256 hex>",
      ...
      { "target": "{workspace_root}/System/Knowledge/referrer.md",
        "pre_state_hash": "<64-char sha256 hex>",
        "op": "replace_line",
